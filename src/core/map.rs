        ...
        match l_node.state {
            HeightIsEqual => {
                return (
                    ...
                    Node {
                        state: RightIsHigher,
                        right: AVLTree::create_node(Node {
                            state: LeftIsHigher,
                            left: l_node.right,
                            ..self
                        }),
...
impl<K: Clone + Ord, V: Clone + Ord> AVLTree<K, V> {
    ...
    fn insert_helper(&self, pair: Pair<K, V>) -> (bool, AVLTree<K, V>, Option<V>) {
        match *self.0 {
            None => (
                true,
                AVLTree::create_node(Node {
                    state: HeightIsEqual,
                    pair: pair,
                    left: AVLTree::create_leaf(),
                    right: AVLTree::create_leaf(),
                }),
                None,
            ),
    ...
    fn delete_helper(&self, key: &K) -> (bool, AVLTree<K, V>, Option<V>) {
        match *self.0 {
            ...
            Some(ref node) => match <AVLTree<K, V>>::compare(key, &node.pair.first) {
                Ordering::Equal => match *node.left.0 {
...
#[cfg(test)]
mod tests {
    use super::super::super::core::value::{Value, ValuePtr};
    use super::*;
    ...
    fn n(
        kv: isize,
        state: SubTreeState,
        left: AVLTree<ValuePtr, ValuePtr>,
        right: AVLTree<ValuePtr, ValuePtr>,
    ) -> AVLTree<ValuePtr, ValuePtr> {
        AVLTree::create_node(Node {
            state: state,
            pair: Pair::new(i(kv), i(kv)),
            left: left,
            right: right,
        })
    }
    ...
    fn test_basic() {
        {
            ...
            assert_eq!(p3, None);
            assert_eq!(t3, n(2, H, n(1, H, l(), l()), n(3, H, l(), l())));
            let (t4, p4) = t3.insert(i(4), i(4));
            assert_eq!(p4, None);
            assert_eq!(
                t4,
                n(2, R, n(1, H, l(), l()), n(3, R, l(), n(4, H, l(), l())))
            );
            ...
            assert_eq!(
                t10,
                n(2, R, n(1, H, l(), l()), n(4, L, n(3, H, l(), l()), l()))
            );
            let (t11, p11) = t10.delete(&i(4));
            assert_eq!(p11, Some(i(4)));
            assert_eq!(t11, n(2, H, n(1, H, l(), l()), n(3, H, l(), l())));
        ...
        }
        {
            ...
            assert_eq!(p3, None);
            assert_eq!(t3, n(6, H, n(5, H, l(), l()), n(7, H, l(), l())));
            let (t4, p4) = t3.insert(i(4), i(4));
            assert_eq!(p4, None);
            assert_eq!(
                t4,
                n(6, L, n(5, L, n(4, H, l(), l()), l()), n(7, H, l(), l()))
            );
            ...
            assert_eq!(
                t10,
                n(6, L, n(4, R, l(), n(5, H, l(), l())), n(7, H, l(), l()))
            );
            let (t11, p11) = t10.delete(&i(4));
            assert_eq!(p11, Some(i(4)));
            assert_eq!(t11, n(6, H, n(5, H, l(), l()), n(7, H, l(), l())));
            let (t12, p12) = t11.delete(&i(5));
            assert_eq!(p12, Some(i(5)));
            assert_eq!(t12, n(6, R, l(), n(7, H, l(), l())));
